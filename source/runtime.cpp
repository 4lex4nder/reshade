...
bool reshade::runtime::update_effect_color_and_stencil_tex(uint32_t width, uint32_t height, api::format color_format, api::format stencil_format)
{
	...
	if (_effect_color_tex != 0 && _effect_width == width && _effect_height == height && _effect_color_format == color_format_typeless && _effect_stencil_format == stencil_format)
	{
		return true;
	}
	...
	color_buffer_cache_format cached_format_key = color_buffer_cache_format { color_format_typeless, width, height };
