...
namespace reshade::d3d11
{
	...
	public:
		...
		void bind_layout(api::shader_stage, api::pipeline_layout) final { assert(false); }
		...
		void bind_stream_output_buffers(uint32_t, uint32_t, const api::resource *, const uint64_t *, const uint64_t *) final { assert(false); }
	...
	public:
		...
		void bind_layout(api::shader_stage stages, api::pipeline_layout layout) final;
